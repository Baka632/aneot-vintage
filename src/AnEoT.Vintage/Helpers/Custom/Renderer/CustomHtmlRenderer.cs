...
public class CustomHtmlRenderer : HtmlRenderer
{
    ...
    /// </summary>
    public CustomHtmlRenderer(TextWriter writer, bool convertWebP, string webRootPath, string? baseUri = null, bool noAd = false, bool noEod = false) : base(writer)
    {
        {
...

        {
            ...
            ObjectRenderers.Insert(htmlBlockRendererIndex, new CustomHtmlBlockRenderer(convertWebP, noAd, noEod, webRootPath));
        ...
        
        {
            ...
            ObjectRenderers.Insert(htmlBlockRendererIndex, new CustomHtmlInlineRenderer(noEod, webRootPath, convertWebP));
